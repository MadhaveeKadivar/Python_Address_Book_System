...
class TestArithmeticOperation(unittest.TestCase):
    ...
    def test_csv_file_write(self):
        ...
        Return:
            returns Nothing
        """
        self.person.create_addressbook("My")
        ab_dict = self.person.add_records('My','zbc','Kadivar','pqr','kmn','uvw',321,12345678,'mk@gmail.com')
        result = self.person.json_file_read()
        result = self.person.csv_file_read()
        self.assertEqual(result,7) # Testing number of rows of csv file
    ...
    def test_json_file_write(self):
        ...
        ab_dict = self.person.add_records('My','zbc','Kadivar','pqr','kmn','uvw',321,12345678,'mk@gmail.com')
        result = self.person.json_file_read()
        self.assertEqual(result,4) # Testing number of records of json file
